/*<$
For the asynchronous graph programming framework Stratimux, define the Concept Helpers model file.
This file defines a series of helper functions that handle the utilization of concepts.
$>*/
/*<#*/
