/*<$
For the asynchronous graph programming framework Stratimux, define the Stage Planner Plan model file.
This file defines how a Muxified Subject creates and manages plans within its Scope.
$>*/
/*<#*/
