...
As this is to Contrast the Traditional understanding of Higher Order Functions. If such needs that Specific Flow, you may Recall the LastActionNode. Or use such Explicitly within a Reducer, Method, or Principle. The Difference here is the direct Blunt nature. As even with Higher Order Functions, the Nesting is the Same Structure at Run Time, but likewise Lacks the Exponential Quality of Decision Making of this Pattern.
